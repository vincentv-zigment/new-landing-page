...
const contentArray = [
  {
    ...
    image: `/assets/imgs/zigment-landing-page/workflow-section/icon-s-322.png`,
  },
  {
    title: "Website Visitors",
    short_description:
      "Engage, Qualify & Convert your website visitors into customers",
    image: `/assets/imgs/zigment-landing-page/workflow-section/icon-s-291.png`,
  },
  {
    title: "Social Audience",
    short_description: "Instantly engage your social media fans from comments or DMs",
    image: `/assets/imgs/zigment-landing-page/workflow-section/icon-s-313.png`,
  },
  {
