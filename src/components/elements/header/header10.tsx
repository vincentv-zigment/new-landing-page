...
const Header10 = ({ headerNav, signUpBtnClassName }: Props) => {
    ...
    <>
      <header
        className={cn(
          ...
          "top-0 left-0 w-full z-[99] border border-border"
        )}
      >
        <div className="container 2xl:max-w-[1750px] full-body-border before:bg-[#07203214] after:bg-[#07203214]">
